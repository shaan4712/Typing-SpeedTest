...
function loadParagraph(){
    ...
    const randomIndex = Math.floor(Math.random() * paragraph.length); //gives index of random para from above list
    ...
    //this allows to type anywhere still working
...
function initTime(){
    if (timeLeft>0){
        ...
        let wpmVal = Math.round(((charIndex - mistake)/5) /(maxTime - timeLeft)*60); //formula
